    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, position: 'relative' }}>
      ...
      <div className="glass glass-strong enter" style={{ width: '100%', maxWidth: 400, borderRadius: 28, padding: 32, position: 'relative', zIndex: 1 }}>
        ...
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingInlineStart: 4 }}>
              <label style={{ fontSize: 13, fontWeight: 700, color: 'var(--ink-2)' }}>סיסמה</label>
              <Link to="/forgot-password" style={{ fontSize: 12.5, fontWeight: 700, color: 'var(--blue)', textDecoration: 'none' }}>שכחתי סיסמה</Link>
            </div>
